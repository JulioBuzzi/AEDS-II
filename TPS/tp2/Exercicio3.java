    ...
    public static void main(String[] args) {
        ...
        while(!(nome = scanner.nextLine()).equals("FIM")){
            ...
            for(int i = 0; i < quantidadePokemons && !encontrou; i++){
                comparacoes++;
                if(pokemons[i].getName().equals(nome)){
                    encontrou = true;
                }
            }
        ...
        try (FileWriter fileWriter = new FileWriter("matricula_sequencial.txt");
            PrintWriter printWriter = new PrintWriter(fileWriter)) {

            printWriter.println(matricula + "\t" + (fim - inicio) / 1000.0 + "s\t" + comparacoes);
